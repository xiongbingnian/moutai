      ...
      <div class="tab-left">
        <ul class="tab-left-cont">
          ...
          <ul class="second-tab">
            ...
            <li @click="selectLeftTab('off')" v-for="(item,index) in standardData" :key="index">
            	<router-link v-bind="{to:'/standard/'+item.id}"><i>L</i>{{item.name}}</router-link>
            </li>
          </ul>
          <li @click="selectLeftTab('off')">
          ...
          <li @click="selectLeftTab('off')">
            <router-link to="/cart">购物车<span class="words-tips">（<b>{{carNum}}</b>）</span></router-link>
          </li>
        </ul>
      </div>
